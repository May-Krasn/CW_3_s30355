...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        ...
        var firstTwo = emps.OrderBy(e => e.HireDate).ToList().Slice(0, 2); 
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        ...
        Assert.True(result.All(r => r.Sal > 500));
    }
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps.Select(e => new {e.EName, Total = e.Sal + (e.Comm != 0 ? e.Comm : 0)}).ToList(); 
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts,
            ...
            .Select(x => new {x.e.EName, x.d.DName, x.g.Grade}).ToList(); 
